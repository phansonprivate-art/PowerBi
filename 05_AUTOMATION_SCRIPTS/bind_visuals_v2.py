...
bilanz_bindings = {
    # --- 4 Card Visuals ---
    "e08628bf944cfaa394aa": {"Values": m("Bilanz Ist")},
    "d93a0fe333574e926bf1": {"Values": m("Bilanz Plan")},
    "2ca0b3beb589aaa2b08f": {"Values": m("GuV Ist")},
    "2944e88e9e19749cc43c": {"Values": m("CF Ist")},
...
guv_bindings = {
    # --- 2 Card Visuals ---
    "f563e92dd75ffd96a26d": {"Values": m("GuV Ist YTD Total")},
    "059feeeae13dc8b22f56": {"Values": m("GuV Plan YTD Total")},
...
cashflow_bindings = {
    # --- 2 Card Visuals ---
    "f563e92dd75ffd96a26d": {"Values": m("CF Ist")},
    "059feeeae13dc8b22f56": {"Values": m("CF Plan")},
...
# ============================================================
pages = [
    (BILANZ, bilanz_bindings, "Bilanz"),
    (GUV, guv_bindings, "GuV"),
    (CASHFLOW, cashflow_bindings, "Cashflow"),
]

total = 0
for page_id, bindings, page_name in pages:
    page_dir = os.path.join(BASE, page_id, "visuals")
    bound = 0
    for vid_prefix, roles in bindings.items():
        # Find matching visual folder (support short IDs)
